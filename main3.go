...
func main() {
	...
	// Save result in csv
	csvFileName := "cpu" + strconv.Itoa(*goFuncCount) + "_rlimit" + strconv.Itoa(*rLimit) + "_maxrlimit" + strconv.Itoa(*maxRLimit) + "_2translate" + "_skip" + strconv.Itoa(*skipTimes) + "_example" + strconv.Itoa(*index) + "_left" + ".csv"
